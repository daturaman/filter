...
public class ResourceFilterBuilder2 implements FilterBuilder2<ResourceFilter, String, String> {
    ...
    private static final String FILTER_FORMAT = "Filter where [property=%s, condition=%s, value=%s]";
    private static final String FILTER_FORMAT_BOOL = "Filter where [property=%s, condition=%s]";
